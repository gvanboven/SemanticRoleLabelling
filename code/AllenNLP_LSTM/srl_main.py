...
if __name__ == '__main__':
    ...
    BATCH_SIZE=32
    GPU_IX=-1
    TRAIN_PATH = "./data/train.jsonl" ###SPECIFY YOUR OWN PATH FOR THE TRAIN FILE
    DEV_PATH = "./data/test.jsonl" ###SPECIFY YOUR OWN PATH FOR THE TEST FILE
    SAVE_MODEL_PATH = f"./{MODEL_TYPE}" # SPECIFY THE LOCATION TO SAVE YOUR MODEL TO
